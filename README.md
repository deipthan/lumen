...
3. Drag **everything inside this folder** (index.html, the index-*.js and
   index-*.css files, .nojekyll) into the upload area and click
   **Commit changes**. The build is flat on purpose — there are no
